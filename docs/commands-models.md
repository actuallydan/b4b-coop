...
Change how your survivor looks for this game session, using only outfits and characters the game already has.
...
- Only looks the game ships: survivor outfits (all of them, also ones you haven't unlocked) and NPC bodies that use
